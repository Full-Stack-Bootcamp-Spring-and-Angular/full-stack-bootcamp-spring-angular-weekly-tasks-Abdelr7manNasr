            ...
            <div class="col-12 col-lg-7 col-xl-6">
                ...
                <div class="app-card shadow-sm">
                    <div class="app-header p-4">
                        <h3 class="app-title">Add New Product</h3>
                        <p class="app-sub">Create a new product and save its details</p>
                    </div>
                        ...
                        <form:form action="processAddProduct" modelAttribute="productModel" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form:input cssClass="form-control" path="productDetails.manufacturer" placeholder="Manufacturer"/>
                                    <div class="error-space">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form:input  cssClass="form-control" path="productDetails.price" placeholder="Price"/>
                                    <div class="error-space">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form:input cssClass="form-control" path="productDetails.available" placeholder="0 or 1"/>
                                    <div class="error-space">
                            ...
                            <div class="d-flex flex-column flex-sm-row gap-2 mt-4">
                                <input type="submit" class="btn btn-orange flex-fill" value="Submit"/>
